...
const OsebergSorOperatorRunde = () => {
  ...
  const [tasks, setTasks] = useState({
    ...
    // Legg til flere områder etter behov
  });

  const areasOppe = ['P23', 'P22', 'P21', 'C22', 'C21', 'Mob båt dekk', 'W21', 'P21 Mess', 'P23 Mess', 'Living Quarter'];
  ...
  const TaskScreen = () => (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        <Button onClick={() => setCurrentScreen('welcome')} variant="outline" size="icon">
      ...
      <Button 
        ...
        className="w-full bg-yellow-600 hover:bg-yellow-700 active:bg-yellow-800"
      >
